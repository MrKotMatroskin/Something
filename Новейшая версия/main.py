...
playButton = Button(10, 250, 70, 25, 'Начать', GREEN)
            ...
            for ray in rays2:
                ...
                for wall in walls:
                    ...
                    if wall.intersecting(ray) is not None:
                        ...
                        distance = ((point[0] - ray.start_pos[0]) ** 2 + (point[1] - ray.start_pos[1]) ** 2) ** 0.5
                ...
                if reflect_angle[1] > 0.2:
                    new_ray = Ray(point_const, reflect_angle[0])
